...
UsersCommon::removeUser( QListWidgetItem* currentItem )
{
    ...
    // Remove user
    KAuth::Action installAction( QLatin1String( "org.ctlos.msm.users.remove" ) );
    installAction.setHelperId( QLatin1String( "org.ctlos.msm.users" ) );
    QVariantMap args;
...
UsersCommon::setUserImage( Ui::PageUsers* ui )
{
    ...
    if ( !copyDest.isEmpty() )
    {
        KAuth::Action installAction( QLatin1String( "org.ctlos.msm.users.changeimage" ) );
        installAction.setHelperId( QLatin1String( "org.ctlos.msm.users" ) );
        QVariantMap args;
