    ...
    m_languageListViewDelegate( new LanguageListViewDelegate )
{
    ...
    KAboutData* aboutData = new KAboutData( LocaleCommon::getName(),
                                            ...
                                            "(c) 2014 - 2017 Ctlos Settings Manager developers" );
...
LocaleModule::save()
{
    if ( m_isLocaleListModified || m_isSystemLocalesModified )
    {
        ...
        // TODO: Progress UI
        KAuth::Action installAction( QLatin1String( "org.ctlos.msm.locale.save" ) );
        installAction.setHelperId( QLatin1String( "org.ctlos.msm.locale" ) );
